...
templates['transcriptTemplate'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  "  <table class=\"table\n                table-hover\">\n    <thead>\n      <tr>\n        <th class=\"episode-title\" colspan=\"4\">\n            <h4>"
    ...
    + "</h4>\n        </th>\n      </tr>\n      <tr>\n        <th>Time</th>\n        <th>Speaker</th>\n        <th>Speech</th>\n        <th>Media</th>\n      </tr>\n    </thead>\n\n    <tbody>\n";
  stack1 = ((helper = (helper = helpers.turns || (depth0 != null ? depth0.turns : depth0)) != null ? helper : alias1),(options={"name":"turns","hash":{},"fn":this.program(2, data, 0),"inverse":this.noop,"data":data}),(typeof helper === alias2 ? helper.call(depth0,options) : helper));
  ...
  return "          <tr>\n            <td class=\"time\">"
    ...
    + "</td>\n            <td>\n              <div>\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.hasAccompanyingMedia : depth0),{"name":"if","hash":{},"fn":this.program(3, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "              </div>\n            </td>\n          </tr>\n";
},"3":function(depth0,helpers,partials,data) {
    var stack1, helper, options, buffer = "";

  stack1 = ((helper = (helper = helpers.accompanyingMedia || (depth0 != null ? depth0.accompanyingMedia : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"accompanyingMedia","hash":{},"fn":this.program(4, data, 0),"inverse":this.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0,options) : helper));
