...
templates['transcriptTemplate'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  return "          <tr>\n            <td class=\"time\">"
    ...
    + "</td>\n            <td>\n              <img src=\""
    + alias3(((helper = (helper = helpers.accompanyingMedia || (depth0 != null ? depth0.accompanyingMedia : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"accompanyingMedia","hash":{},"data":data}) : helper)))
